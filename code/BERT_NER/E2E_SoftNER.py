...
def create_segmenter_input(conll_format_file, segmenter_input_file, ctc_classifier, vocab_size, word_to_id, id_to_word,
                           word_to_vec, features):
...
def create_ner_input(segmenter_output_file, ner_input_file, ctc_classifier, vocab_size, word_to_id, id_to_word,
                     word_to_vec, features):
...
def Extract_NER(input_file):
    ...
    create_segmenter_input(conll_file, segmenter_input_file, ctc_classifier, vocab_size, word_to_id, id_to_word,
                           word_to_vec, features)

    softner_segmenter_preditct_from_file.predict_segments(segmenter_input_file, segmenter_output_file)

    create_ner_input(segmenter_output_file, ner_input_file, ctc_classifier, vocab_size, word_to_id, id_to_word,
                     word_to_vec, features)
