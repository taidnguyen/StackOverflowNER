...
RESOURCES = {
    "train": "/content/drive/MyDrive/StackOverflowNER/data/train_freq.txt",
    "gigaword_word": "/content/drive/MyDrive/StackOverflowNER/data/gigaword_gt_2.bin",
    "gigaword_char": "/content/drive/MyDrive/StackOverflowNER/data/gigaword_char_unique.bin",
    "stackoverflow_char": "/content/drive/MyDrive/StackOverflowNER/data/no_eng_char_uniq.bin",
    "stackoverflow_word": "/content/drive/MyDrive/StackOverflowNER/data/words.bin",
    "cs": "/content/drive/MyDrive/StackOverflowNER/data/sorted_semantic_scholar_words.txt"
}
...
if __name__ == '__main__':
    ...
    print(word_to_id)
    ip_token = "app"
    op_ctc = prediction_on_token_input(ip_token, ctc_classifier, vocab_size, word_to_id, id_to_word, word_to_vec,
                                       features)
    print(op_ctc)
